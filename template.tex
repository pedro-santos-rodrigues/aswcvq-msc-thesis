...
\documentclass[
  ...
  school=nova/fct,      % nova/fct(*), nova/fcsh, nova/ims, ul/ist, ul/fc, ipl/isel
  lang=en,              % en(*), fr, it, pt
...
\title[Accelerating SQL with Complex Visual Querying]{Accelerating SQL with Complex Visual Querying}
%\subtitle{Science is beautiful}

% Autor
% use [f] for female and [m] for male
\authorname[m]{Pedro Santos Rodrigues}{Pedro Rodrigues}
\authordegree{Bachelor in Computer Science}

% Date
\datemonth{\DTMmonthname{\month}}
\dateyear{\the\year}

% Front page image - for ISEL template - must be 12 x 8 cm
%\frontpageimage{frontPageImage.png}


% Advisers
% use "\\&" if necessary to break the lines in the apprpriate place
% use [f] for female and [m] for male
\adviser[f]{Teresa Romão}{Associate Professor}{\\& NOVA University of Lisbon} 
...
% use [f] for female and [m] for male
\coadviser[m]{Rui Nóbrega}{Assistant Professor}{\\& NOVA University of Lisbon}
% \coadviser[f]{[Nome da co-orientadora 2]}{[Profª.\ Auxiliar]}{[Universidade Nova de Lisboa]}

\coadviser[m]{Tiago Simões}{Principal Product Designer}{\\& OutSystems}

% committee (maximum of 9 elements)
% Use [c] for chair, [r] for raporteurs, [a] for advisers, [m] or nothing for remaining members
% Chair of the committee
\committee[c,m]{Henrique Domingos, Associate Professor, NOVA University of Lisbon}
% Main raporteurs
\committee[r,m]{António Coelho, Associate Professor with Habilitation, FEUP}
%\committee[r,f]{Name of another raporteur}
% Advisers
%\committee[a,f]{Teresa Isabel Lopes Romão, Associate Professor, NOVA University of Lisbon}
...
\committee[m,f]{Teresa Romão, Associate Professor, NOVA University of Lisbon}
