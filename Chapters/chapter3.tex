...
\begin{figure}[htbp]
    ...
    \\
    \subcaptionbox{Tableau Prep\label{fig:tableauJoinPanel} (source: \cite{tableauJoinImage})}%
...
\resizebox{\textwidth}{!}{
  \begin{tabular}{|
    ...
    \multicolumn{2}{|c|}{\cellcolor[HTML]{9B9B9B}\textbf{Feature \textbackslash System}} &
      \multicolumn{1}{c|}{\cellcolor[HTML]{9B9B9B}\textbf{\begin{tabular}[c]{@{}c@{}}Chartio \\ Data Explorer\end{tabular}}} &
      \multicolumn{1}{c|}{\cellcolor[HTML]{9B9B9B}\textbf{\begin{tabular}[c]{@{}c@{}}Chartio \\ Visual SQL\end{tabular}}} &
      \multicolumn{1}{c|}{\cellcolor[HTML]{9B9B9B}\textbf{\begin{tabular}[c]{@{}c@{}}Tableau \\ Prep\end{tabular}}} &
      \multicolumn{1}{c|}{\cellcolor[HTML]{9B9B9B}\textbf{\begin{tabular}[c]{@{}c@{}}Power BI \\ Query Editor\end{tabular}}} &
      \multicolumn{1}{c|}{\cellcolor[HTML]{9B9B9B}\textbf{\begin{tabular}[c]{@{}c@{}}Devart dbForge \\ Query Builder\end{tabular}}} \\ \hline
    \cellcolor[HTML]{C0C0C0} &
      Only the required &
      \multicolumn{1}{c|}{\cellcolor[HTML]{97CB97}} &
      \multicolumn{1}{c|}{\cellcolor[HTML]{97CB97}} &
      \multicolumn{1}{c|}{\cellcolor[HTML]{97CB97}} &
      \multicolumn{1}{c|}{\cellcolor[HTML]{A2211E}} &
      \multicolumn{1}{c|}{\cellcolor[HTML]{97CB97}} \\ \cline{2-7} 
    \cellcolor[HTML]{C0C0C0} &
    ...
    \cellcolor[HTML]{C0C0C0} &
      Cross Join &
       &
       &
      \cellcolor[HTML]{C0C0C0}\begin{tabular}[c]{@{}l@{}}Using\\ Calculated\\ Attributes\end{tabular} &
      \cellcolor[HTML]{C0C0C0}\begin{tabular}[c]{@{}l@{}}Using\\ Calculated\\ Attributes\end{tabular} &
      \cellcolor[HTML]{C0C0C0}Textually \\ \cline{2-7} 
    \cellcolor[HTML]{C0C0C0} &
      Null Option &
       &
       &
      \cellcolor[HTML]{A2211E} &
       &
      \cellcolor[HTML]{A2211E} \\ \cline{2-7} 
    \multirow{-7}{*}{\cellcolor[HTML]{C0C0C0}\textbf{Merge}} &
      \begin{tabular}[c]{@{}l@{}}Define Join \\ Condition\end{tabular} &
       &
       &
       &
      \cellcolor[HTML]{C0C0C0}\begin{tabular}[c]{@{}l@{}}Selecting\\ Columns\\ Visually\end{tabular} &
      \cellcolor[HTML]{C0C0C0}Textually \\ \hline
