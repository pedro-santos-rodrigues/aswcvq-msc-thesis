...
\label{subsec:efficiency}
  ...
  \begin{figure}[tb]
    \centering
    \subcaptionbox{Existing Interface\label{fig:durationDiagramExistingInterface}}%
      {\includegraphics[width=1.0\linewidth]{duration-diagram-existing-interface}}%
      \\
    \subcaptionbox{Final Prototype\label{fig:durationDiagramExistingInterface}}%
    {\includegraphics[width=1.0\linewidth]{duration-diagram-final-prototype}}%
