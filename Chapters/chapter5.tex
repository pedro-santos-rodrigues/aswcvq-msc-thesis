...
\begin{figure}[htbp]
	\centering
	\includegraphics[height=3.0in]{aggregate-filter-modal}
...
The description of all problems and suggestions posted in the OutSystems community are detailed in Appendix \ref{app:taxonomy_of_problems_existing_interface} - \nameref{tab:taxonomy_of_existing_problems} in a table that aggregates all problems identified throughout this problem analysis process.
...
It was tested 10 users of each group and the detailed information about the usability test participants' profile is presented in Table \ref{tab:survey_profile_existing_interface} of Appendix \ref{app:usability_tests_results} - \nameref{app:usability_tests_results}.
...
% \usepackage{booktabs}
\begin{table}[tb]
    \caption{\textbf{Evaluation point S14:} Success rate of users when they needed to add a calculated attribute (Existing Interface usability tests - 30 users).}
...
% \usepackage{booktabs}
\begin{table}[tb]
    \caption{\textbf{Evaluation point S7:} Readability rate of the join which represents the case where two entities were merged using a left join and the conditions specified the that the primary key of the right enitity must be null (Existing Interface usability tests - 30 users).}
...
% \usepackage{booktabs}
\begin{table}[tb]
    \caption{\textbf{Evaluation point S8:} Readability of the foreign keys used to join entities that could be joined using different attributes (Existing Interface usability tests - 30 users).}
...
\begin{table}[tb]
    \caption{\textbf{Evaluation point S1:} Average success rate of all scenarios by user group (Existing Interface usability tests - 30 users).}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[height=2.4in]{effectiveness-existing-interface-user-group}
	\caption{\textbf{Evaluation point S1:} Average of the sucess rate of all scenarios by each user group (Existing Interface usability tests - 30 users).}
...
\begin{figure}[htbp]
    \centering
    \subcaptionbox{"Insuccess rate vs. Have you used a query language (SQL or other)?"\label{fig:existingInterfaceSqlSuccessRate}}%
      {\includegraphics[height=3.0in]{existing-interface-sql-sucess-rate}}%
      \\
    \subcaptionbox{"Insuccess rate vs. Have you already used OutSystems?"\label{fig:existingInterfaceOutsystemsSuccessRate}}%
...
\begin{table}[h]
    ...
    \begin{tabular}{|
    >{\columncolor[HTML]{C0C0C0}} C{3cm} |C{11cm}|}
    \hline
