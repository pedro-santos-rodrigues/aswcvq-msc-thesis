...
\begin{table}[h]
    ...
    \hline
    \begin{tabular}[c]{@{}l@{}}Software \\ Developer\end{tabular}   & Software Developer or Engineer who has a good and solid previous knowledge of programming and databases. The principal capabilities of these users are programming languages, such as C\#, SQL, and others. These users cannot abstract their previous knowledge, so communication with these users is more technical and specific. Finally, this user group is not an expert in low-code development. However, as they have solid programming, logic, and database knowledge, probably they could develop some applications using low-code. \\ \hline
